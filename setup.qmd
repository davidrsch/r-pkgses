...
## Prepare your system {#sec-setup-prep}
...
## R build toolchain {#sec-setup-tools}
...
You need to install the Xcode command line tools, which requires that you [register as an Apple developer](https://developer.apple.com/programs/enroll/).
Don't worry, this is free for an individual who only wishes to install apps, such as Xcode command line tools.
Enrolling in the paid developer program is only necessary for those who want distribute apps, access beta software, and integrate with capabilities such as Siri, Apple Pay, and iCloud.

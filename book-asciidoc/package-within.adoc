...
#> [1] "2025-August-06_22-02-57_swim_clean.csv"
...
----
outfile_path("INFILE.csv")
#> [1] "2025-August-06_22-02-57_INFILE_clean.csv"

format(Sys.time(), "%Y-%B-%d_%H-%M-%S")
#> [1] "2025-August-06_22-02-58"
----

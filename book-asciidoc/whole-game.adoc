...
....
#> ✔ Creating '/tmp/RtmpqMNDJZ/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpqMNDJZ/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|2707fac184… |Quarto GHA Workflow Runner quarto-github-actions-publish@example.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpqMNDJZ/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpqMNDJZ/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpqMNDJZ/regexcite/README.Rmd'
----
